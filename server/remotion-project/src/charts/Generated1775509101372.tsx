...
export const BarChart: React.FC<BarChartProps> = ({
  ...
  // const minValue = Math.min(...data, 0); // Não é usado diretamente para cálculo de altura de barra positiva
  ...
  console.log(`[${new Date().toISOString()}] GiantAnimator: Regenerating BarChart frame ${frame}.`);
