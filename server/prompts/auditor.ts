...
- **LABELS GENÉRICOS**: O uso de "Item 1", "Item 2" quando a referência tem nomes reais. E também a criação de "Series 1" se a imagem original NÃO POSSUI legendas. Precisão nominal absoluta.
