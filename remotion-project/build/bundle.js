...
const THEME = {
  ...
  spring: {
    // ✅ CALIBRADO — Vertical Bar Chart (leve retorno elástico profissional)
    bar: { damping: 14, stiffness: 60, mass: 1 },
    // UI rápida / stagger genérico
    snappy: { damping: 20, stiffness: 200, mass: 1 },
    // Linha / Area Chart (ease-in-out suave)
    smooth: { damping: 30, stiffness: 80, mass: 1 },
    // Efeito elástico pronunciado
    bouncy: { damping: 8, stiffness: 100, mass: 1 },
    // Sem overshoot — corte seco
    noBlur: { damping: 200, stiffness: 200, mass: 1 }
  },
  font: {
...
const BarChart = ({
  ...
  const labelXHeight = 32 * scale;
  const plotWidth = width - 2 * padding;
  const plotHeight = height - 2 * padding - titleHeight - labelXHeight;
  ...
  const barGap = 0.3;
  const barWidthRatio = 1 - barGap;
  const categoryWidth = numBars > 0 ? plotWidth / numBars : 0;
  const barWidth = categoryWidth * barWidthRatio;
  const barXPositions = data.map((_, i) => {
    const totalGapWidth = categoryWidth * barGap;
    return padding + i * categoryWidth + totalGapWidth / 2;
  });
  const numGridLines = 5;
  const gridLineValues = Array.from({ length: numGridLines + 1 }).map(
    (_, i) => maxDataValue / numGridLines * i
  );
  const gridLineYPositions = gridLineValues.map((value) => {
    return height - padding - labelXHeight - value / maxDataValue * plotHeight;
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width, height, style: { backgroundColor: THEME.colors.background }, children: [
    title && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "text",
      {
        x: width / 2,
        y: padding + titleHeight / 2 + 8 * scale,
        textAnchor: "middle",
    ...
    Array.isArray(gridLineYPositions) && gridLineYPositions.map((y, i) => {
    ...
    Array.isArray(gridLineValues) && gridLineValues.map((value, i) => {
      const y = gridLineYPositions[i];
      const opacity = (0,esm.interpolate)(
        (0,esm.spring)({
          frame,
          fps,
    ...
    Array.isArray(data) && data.map((d, i) => {
      const barStartX = barXPositions[i];
      const valueRatio = maxDataValue > 0 ? d.value / maxDataValue : 0;
      const rawBarHeight = valueRatio * plotHeight;
      const animatedHeight = (0,esm.interpolate)(
        (0,esm.spring)({
          frame: frame - 10 - i * 6,
          // Stagger animation start by 6 frames
          fps,
      ...
      const safeBarHeight = d.value > 0 ? Math.max(animatedHeight, 4 * scale) : 0;
      const barY = height - padding - labelXHeight - safeBarHeight;
      const valueLabelOpacity = (0,esm.interpolate)(
        (0,esm.spring)({
          frame: frame - 50 - i * 6,
          // Labels appear later
          fps,
      ...
      const safeBarX = isNaN(barStartX) ? 0 : barStartX;
      const safeBarY = isNaN(barY) ? 0 : barY;
      const safeBarWidth = isNaN(barWidth) ? 0 : barWidth;
      const safeSafeBarHeight = isNaN(safeBarHeight) ? 0 : safeBarHeight;
      return /* @__PURE__ */ (0,jsx_runtime.jsxs)(react.Fragment, { children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "linearGradient",
          {
            ...
            y2: "100%",
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "0%", stopColor: barColor, stopOpacity: 1 }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "100%", stopColor: barColor, stopOpacity: 0.7 })
            ]
          }
        ) }),
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ...
          {
            x: safeBarX + safeBarWidth / 2,
            y: height - padding - labelXHeight + 20 * scale,
            textAnchor: "middle",
            dominantBaseline: "middle",
            fontSize: 12 * scale,
            fill: THEME.colors.textMuted,
...
/* harmony default export */ const charts_BarChart = ((/* unused pure expression or super */ null && (BarChart)));

;// ./src/charts/LineChart.tsx


const LineChart = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });

;// ./src/charts/PieChart.tsx


const PieChart = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });

;// ./src/charts/MultiLineChart.tsx


const MultiLineChart = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });

;// ./src/charts/AreaChart.tsx


const AreaChart = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });

;// ./src/charts/HorizontalBarChart.tsx


const HorizontalBarChart = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });

;// ./src/charts/ScatterPlot.tsx


const ScatterPlot = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });

;// ./src/charts/WaterfallChart.tsx


const WaterfallChart = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });

;// ./src/charts/CandlestickChart.tsx


const CandlestickChart = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });

;// ./src/charts/Heatmap.tsx


const Heatmap = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, viewBox: "0 0 1280 720", style: { background: "#000" } });
...
const RemotionRoot = () => /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "BarChart", component: BarChart, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: { data: [{ label: "A", value: 1 }] } }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "LineChart", component: LineChart, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: { data: [{ label: "A", value: 1 }] } }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "PieChart", component: PieChart, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: { data: [{ label: "A", value: 1 }] } }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "MultiLineChart", component: MultiLineChart, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: { series: [{ label: "A", data: [1], color: "#FF0000" }], labels: ["0"] } }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "AreaChart", component: AreaChart, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: {} }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "HorizontalBarChart", component: HorizontalBarChart, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: {} }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "ScatterPlot", component: ScatterPlot, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: {} }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "WaterfallChart", component: WaterfallChart, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: {} }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "CandlestickChart", component: CandlestickChart, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: {} }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "Heatmap", component: Heatmap, durationInFrames: 120, fps: 30, width: 1280, height: 720, defaultProps: {} })
] });
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(409), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 9409)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "remotion-project:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkremotion_project"] = self["webpackChunkremotion_project"] || [];
